...
<body>
    <div class="container mt-5">
        ...
        <form method="POST" class="border rounded bg-light p-2">
            ...
            placeholder="Masukkan harga barang" min="0" autocomplete="off" required onkeypress="return
             event.charCode >= 48 && event.charCode <=57">
             <label class="form-label">Diskon (%)</label>
            <input type="text" maxlength="3" name="diskon" class="form-control" step="0.01" 
            placeholder="Masukkan diskon (0-100)" min="0" autocomplete="" required onkeypress="return
             event.charCode >= 48 && event.charCode <=57">
...
?>
    ...
    <p class="text-center">&copy; UKK RPL 2025 | M Shafa Ariq Yasaputra | XI RPL</p>
